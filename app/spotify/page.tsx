...
import { Music, Loader, Sparkles, LogOut } from "lucide-react";
...
export default function SpotifyPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#002922]">
      ...
      <div className="container relative flex items-center justify-center min-h-screen py-">
        <AnimatePresence mode="wait">
          ...
          >
            {isLoading ? (
              ...
              <Card className="w-full max-w-[31rem] backdrop-blur-sm bg-white/5 dark:bg-gray-950/20 border-emerald-100/10 dark:border-emerald-900/20 overflow-hidden">
                <CardHeader className="flex flex-row items-center justify-between">
                  ...
                  <Button
                    ...
                    className="text-white/60 hover:text-white hover:bg-emerald-500/20"
                  >
                    {isLoggingOut ? (
                ...
                <CardContent>
                  <SpotifyNowPlaying isOwner={true} />
                </CardContent>
              </Card>
            ) : (
