...
// import { pageGroups, socialLinks } from "@/constants/footer";
...
//     <footer
//       ref={footerRef}
//       className="w-full bg-gradient-to-b from-[#002922] to-[#01372e] relative border-t border-emerald-500/10 text-white py-10 px-4 md:px-4 overflow-hidden"
//     >
...
//           <motion.div
//             key={i}
//             className="absolute bg-emerald-400/5 rounded-full blur-xl"
//             style={{
...
//       {/* Background Name */}
//       <div className="absolute inset-0 items-center justify-center pointer-events-none select-none opacity-[0.02] overflow-hidden">
//         <motion.h1
//           className="text-[8rem] md:text-[11rem] lg:text-[14rem] font-bold whitespace-nowrap text-emerald-400"
...
//           initial="hidden"
//           animate={controls}
//           className="grid grid-cols-1 md:grid-cols-12 justify-between"
//         >
//           {/* Brand Section */}
//           <motion.div
//             variants={itemVariants}
//             className="justify-start items-center md:col-span-4 space-y-6"
//           >
...
//               <div className="Space-y-4">
//             <div>
//               <h2 className="inline-block text-2xl pb-2 mb-2 border-b-4 border-blue-600">Connect With Me</h2>
//             </div>
...
//           <motion.nav
//             variants={itemVariants}
//             className="md:col-span-8 grid grid-cols-1 sm:grid-cols-2 justify-end"
//           >
...
//               Made with{" "}
//               <FaHeart className="h-3 w-3 text-emerald-500 animate-pulse" /> in
//               Rwanda
//             </p>
//           </motion.div>
//         </motion.div>
