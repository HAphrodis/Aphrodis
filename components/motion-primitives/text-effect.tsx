...
const hasTransition = (
  variant: Variant,
): variant is { transition?: Transition } => {
  return (
...
export function TextEffect({
  ...
  // Check if children is a string, if not, render it directly with animations
      ...
      <AnimatePresence mode="wait">
        {trigger && (
          <MotionTag
            ...
            animate="visible"
            exit="exit"
            variants={variants?.container || presetVariants[preset].container}
            className={className}
          ...
          >
            <motion.div
              variants={variants?.item || presetVariants[preset].item}
